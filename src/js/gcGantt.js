...
function GCGantt(elementId, tasks, resources, options) {
   ...
   var _options = {
      showStartDate: this.getOption(options, 'showStartDate', false), // Show start date column
      showEndDate: this.getOption(options, 'showEndDate', false), // Show end date column
